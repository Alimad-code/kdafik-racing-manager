...
LEGAL_DOCUMENTS = (
    {
        ...
        "kind": "privacy_policy",
        "version": "dev-2026-08-15",
        "title": "Политика обработки персональных данных (DEV)",
        "public_path": "/legal/privacy",
        "content_sha256": "4f61022d6105668255a6e4ccb151c918edd24f0b329df1053a119734d877da31",
    ...
    },
    {
        ...
        "version": "dev-2026-08-15",
        "title": "Согласие на обработку персональных данных (DEV)",
        "public_path": "/legal/consent",
        "content_sha256": "8579b6bc3a249969959c6c827d13716e3e116ac19ac7367ebccb05f9bce0208a",
        "effective_at": datetime(2026, 8, 15, tzinfo=UTC),
        "required_at_registration": True,
    },
    {
        ...
        "kind": "user_agreement",
        "version": "dev-2026-08-15",
        "title": "Пользовательское соглашение (DEV)",
        "public_path": "/legal/agreement",
        "content_sha256": "f60d8aba2fd6d2dd893d11b1c94bd12cd8d31ab4821f43545acf85b63d0c6676",
        "effective_at": datetime(2026, 8, 15, tzinfo=UTC),
        "required_at_registration": True,
    },
)
